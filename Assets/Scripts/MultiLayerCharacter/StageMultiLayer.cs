...
[ExecuteInEditMode]
public class StageMultiLayer : PortraitControllerMultiLayer
{
    ...
    protected List<CharacterMultiLayer> charactersOnStage = new List<CharacterMultiLayer>();

    protected static List<StageMultiLayer> activeStages = new List<StageMultiLayer>();
    ...
    /// </summary>
    public static List<StageMultiLayer> ActiveStages { get { return activeStages; } }

    /// <summary>
    /// Returns the currently active stage.
    /// </summary>
    public static StageMultiLayer GetActiveStageMult()
    {
        if (StageMultiLayer.activeStages == null ||
            StageMultiLayer.activeStages.Count == 0)
        {
            return null;
        }

        return StageMultiLayer.activeStages[0];
    }
    ...
    /// </summary>
    public virtual List<CharacterMultiLayer> CharactersOnStage { get { return charactersOnStage; } }
